  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto pb-16 px-4 sm:pb-24 sm:px-6 lg:px-8">
        ...
        <div className="my-8 md:my-0 course-cards flex space-x-8 no-scrollbar overflow-x-scroll items-stretch py-10">
          {courses
            ...
            .map((course) => (
              <a
                ...
                key={course.key}
                className="flex align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left shadow-lg hover:shadow-xl transform transition-all sm:align-middle sm:max-w-lg sm:w-full sm:p-6 !pr-0 justify-between items-stretch min-w-fit border border-gray-100"
              >
                <div>
                  {" "}
