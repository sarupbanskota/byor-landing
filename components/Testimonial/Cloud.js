        ...
        <div className="flex justify-center ">
          ...
          {/* <TestimonialCard
            ...
            testimonial={{
              ...
              content: (
                <>
                  I've started the Docker challenge. Just the right level of
                  guidance, helpful and still gives you a lot of freedom to
                  explore and learn for yourself.
                </>
              ),
            }}
          /> */}
        ...
        like Git and Docker from scratch. <br/><br/>Seems like a cool way to build a stronger mental model of how those tools work.
          ...
          {/* <TestimonialCard
            ...
            testimonial={{
              ...
              content: (
                <>
                  I ended up building the whole thing myself. As an SRE (and
                  mostly a user of Docker), digging into its internals blew me
                  away.
                  <br />
                </>
              ),
